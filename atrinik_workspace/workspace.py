        ...
        *,
        ...
        with self._profile_build_lock(root, profile_name):
            ...
            if integrated_classic:
                ...
                integrated_arguments: dict[str, Any] = {
                    "sound_root": sound_root,
                }
                if selective_build:
                    integrated_arguments["build_services"] = build_services
                if gpu_shader is not None:
                    integrated_arguments["gpu_shader"] = gpu_shader
                self._build_integrated_classic(
                    root, selected, tests, **integrated_arguments
                )
            else:
                ...
                if "client" in targets and "client" in build_services:
                    ...
                    if gpu_shader is not None:
                        client_arguments["gpu_shader"] = gpu_shader
                    self._build_client(
