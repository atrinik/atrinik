...
PLUGIN_HOOK_FUNCTION(object *, object_insert_into, object *, object *, int)
...
PLUGIN_HOOK_FUNCTION(void , object_update_speed, object *)
...
PLUGIN_HOOK_FUNCTION(bool , attack_kill, object *, object *)
...
PLUGIN_HOOK_FUNCTION(object *, object_load_str, const char *)
...
PLUGIN_HOOK_FUNCTION(object *, object_clone, const object *)
PLUGIN_HOOK_FUNCTION(object *, object_get, void)
PLUGIN_HOOK_FUNCTION(void , object_copy, object *, const object *, bool)
PLUGIN_HOOK_FUNCTION(bool , object_enter_map, object *, object *, mapstruct *, int, int, bool)
...
PLUGIN_HOOK_FUNCTION(object *, object_insert_map, object *, mapstruct *, object *, int)
PLUGIN_HOOK_FUNCTION(const char *, shop_get_cost_string, int64_t)
...
PLUGIN_HOOK_FUNCTION(shstr *, object_get_value, const object *, const char *const)
PLUGIN_HOOK_FUNCTION(bool , object_set_value, object *, const char *, const char *, bool)
...
PLUGIN_HOOK_FUNCTION(void , object_dump, const object *, StringBuffer *)
...
PLUGIN_HOOK_FUNCTION(int , object_get_gender, const object *)
PLUGIN_HOOK_FUNCTION(object *, object_decrease, object *, uint32_t)
...
PLUGIN_HOOK_FUNCTION(treasure_list_t *, treasure_list_find, const char *)
PLUGIN_HOOK_FUNCTION(void , treasure_generate, treasure_list_t *, object *, int, int)
PLUGIN_HOOK_FUNCTION(void , object_dump_rec, const object *, StringBuffer *)
PLUGIN_HOOK_FUNCTION(int , attack_hit, object *, object *, int)
...
PLUGIN_HOOK_FUNCTION(int , map_free_spot, mapstruct *, int, int, int, int, struct archetype *, object *)
...
PLUGIN_HOOK_FUNCTION(int , connection_object_get_value, const object *)
...
PLUGIN_HOOK_FUNCTION(object *, object_get_env, object *)
