...
PLUGIN_HOOK_FUNCTION(object *, load_object_str, char *)
PLUGIN_HOOK_FUNCTION(int64_t, query_cost, object *, object *, int)
PLUGIN_HOOK_FUNCTION(int64_t, query_money, object *)
PLUGIN_HOOK_FUNCTION(int , pay_for_item, object *, object *)
PLUGIN_HOOK_FUNCTION(int , pay_for_amount, int64_t, object *)
...
PLUGIN_HOOK_FUNCTION(int , find_face, char *, int)
PLUGIN_HOOK_FUNCTION(int , find_animation, char *)
