...
extern int command_learn_spell(object *op, char *params);
extern int command_learn_special_prayer(object *op, char *params);
extern int command_forget_spell(object *op, char *params);
extern int command_listplugins(object *op, char *params);
extern int command_loadplugin(object *op, char *params);
extern int command_unloadplugin(object *op, char *params);
extern void shutdown_agent(int timer, char *reason);
extern int command_motd_set(object *op, char *params);
extern int command_ban(object *op, char *params);
extern int command_debug(object *op, char *params);
extern int command_dumpbelowfull(object *op, char *params);
...
extern int command_dumpactivelist(object *op, char *params);
extern int command_shutdown(object *op, char *params);
extern int command_setmaplight(object *op, char *params);
...
extern int command_map_patch(object *op, char *params);
...
/* src/server/ban.c */
extern void load_bans_file();
extern void save_bans_file();
...
extern object *get_next_requested_path();
...
extern ob_race *race_get_random();
extern void race_init();
extern void race_dump();
extern void race_free();
...
extern void init_new_exp_system();
extern void free_exp_objects();
extern void dump_skills();
...
/* src/server/swap.c */
extern void read_map_log();
extern void swap_map(mapstruct *map, int force_flag);
extern void check_active_maps();
extern void flush_old_maps();
/* src/server/time.c */
...
extern void init_world_darkness();
extern void tick_the_clock();
...
extern void free_socket_images();
extern void read_client_images();
...
extern void init_ericserver();
extern void free_all_newserver();
extern void free_newsocket(socket_struct *ns);
extern void init_srv_files();
extern void free_srv_files();
...
extern void doeric_server();
extern void doeric_server_write();
...
extern void metaserver_info_update();
...
extern void yy_map_headerpop_buffer_state();
extern int yy_map_headerget_lineno();
extern FILE *yy_map_headerget_in();
extern FILE *yy_map_headerget_out();
extern int yy_map_headerget_leng();
extern char *yy_map_headerget_text();
...
extern int yy_map_headerget_debug();
extern void yy_map_headerset_debug(int bdebug);
extern int yy_map_headerlex_destroy();
...
extern void yy_objectpop_buffer_state();
extern int yy_objectget_lineno();
extern FILE *yy_objectget_in();
extern FILE *yy_objectget_out();
extern int yy_objectget_leng();
extern char *yy_objectget_text();
...
extern int yy_objectget_debug();
extern void yy_objectset_debug(int bdebug);
extern int yy_objectlex_destroy();
...
extern void yy_random_mappop_buffer_state();
extern int yy_random_mapget_lineno();
extern FILE *yy_random_mapget_in();
extern FILE *yy_random_mapget_out();
extern int yy_random_mapget_leng();
extern char *yy_random_mapget_text();
...
extern int yy_random_mapget_debug();
extern void yy_random_mapset_debug(int bdebug);
extern int yy_random_maplex_destroy();
