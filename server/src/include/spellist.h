...
spell_struct spells[NROFREALSPELLS] = {
    ...
    {"cure poison",
        5, 8, 3, 6, 4, 1.0,
        0, 0, 0, 0, 0, "magic_stat.ogg",
        SPELL_USE_CAST | SPELL_USE_POTION, SPELL_DESC_SELF | SPELL_DESC_FRIENDLY | SPELL_DESC_TOWN,
    ...
    {"strength self",
        ...
        SPELL_USE_CAST | SPELL_USE_WAND | SPELL_USE_POTION | SPELL_USE_ROD | SPELL_USE_SCROLL, SPELL_DESC_SELF | SPELL_DESC_TOWN,
        PATH_SELF, "meffect_yellow", NULL},

    {"identify",
        5, 8, 3, 6, 2, 1.0,
        0, 0, 0, 0, 0, "magic_default.ogg",
        SPELL_USE_CAST | SPELL_USE_WAND | SPELL_USE_ROD | SPELL_USE_SCROLL, SPELL_DESC_SELF | SPELL_DESC_TOWN,
    ...
    {"remove curse",
        5, 8, 3, 6, 2, 1.0,
        0, 0, 0, 0, 0, "magic_default.ogg",
        SPELL_USE_CAST | SPELL_USE_SCROLL, SPELL_DESC_SELF | SPELL_DESC_TOWN | SPELL_DESC_FRIENDLY,
    ...
    {"probe",
        2, 8, 3, 6, 0, 1.0,
        0, 0, 0, 0, 0, "magic_default.ogg",
        SPELL_USE_CAST | SPELL_USE_SCROLL | SPELL_USE_WAND | SPELL_USE_ROD, SPELL_DESC_TOWN | SPELL_DESC_DIRECTION,
        PATH_INFO, "probebullet", NULL},

    {"town portal",
        30, 8, 1, 0, 3, 1.0,
        0, 0, 0, 0, 0, "magic_stat.ogg",
        SPELL_USE_CAST | SPELL_USE_SCROLL, SPELL_DESC_SELF,
