...
spell_struct spells[NROFREALSPELLS] = {
    ...
    {"asteroid",
        ...
        SPELL_USE_CAST, SPELL_DESC_DIRECTION | SPELL_USE_BOOK,
    ...
    {"create food",
        ...
        SPELL_USE_CAST, SPELL_DESC_DIRECTION | SPELL_DESC_TOWN | SPELL_USE_BOOK,
    ...
    {"greater healing",
        6, 8, 3, 0, 3, 1.0,
        0, 0, 0, 0, 0, "magic_stat.ogg",
        SPELL_USE_CAST | SPELL_USE_BALM | SPELL_USE_SCROLL | SPELL_USE_ROD | SPELL_USE_POTION, SPELL_DESC_SELF | SPELL_DESC_FRIENDLY | SPELL_DESC_TOWN | SPELL_USE_BOOK,
        PATH_RESTORE, "meffect_green", NULL},
    ...
    {"protection from cold",
        ...
        SPELL_USE_CAST | SPELL_USE_BALM, SPELL_DESC_SELF | SPELL_DESC_FRIENDLY | SPELL_DESC_TOWN | SPELL_USE_BOOK,
        PATH_PROT, NULL, NULL},
    ...
    {"finger of death",
        ...
        SPELL_USE_CAST, SPELL_DESC_ENEMY | SPELL_USE_BOOK,
    ...
    {"transform wealth",
        ...
        SPELL_USE_CAST | SPELL_USE_WAND, SPELL_DESC_DIRECTION | SPELL_DESC_TOWN | SPELL_USE_BOOK,
        PATH_TRANSMUTE, NULL, NULL},

    {"magic missile",
        3, 8, 3, 6, 9, 1.0,
        4, 5, 4, 4, 9, "magic_missile.ogg",
        SPELL_USE_CAST | SPELL_USE_WAND | SPELL_USE_ROD, SPELL_DESC_ENEMY | SPELL_USE_BOOK,
    ...
    {"frostbolt",
        ...
        SPELL_USE_CAST | SPELL_USE_WAND | SPELL_USE_ROD, SPELL_DESC_DIRECTION | SPELL_USE_BOOK,
