...
spell spells[NROFREALSPELLS] =
{
	...
	{"detect curse", SPELL_TYPE_PRIEST,
	 1, 5, 8, 3, 6, 0, 1.0,
	 0, 0, 0, 0, 0, SOUND_MAGIC_DEFAULT,
	 SPELL_USE_CAST | SPELL_USE_WAND | SPELL_USE_ROD | SPELL_USE_SCROLL | SPELL_USE_BOOK, SPELL_DESC_SELF | SPELL_DESC_TOWN | SPELL_DESC_WIS,
	 PATH_INFO, "meffect_pink"
	},
