...
void apply_armour_improver(object *op, object *tmp)
{
	...
	if (!armor)
	{
		draw_info(0, COLOR_WHITE, op, "You need to mark an armor object.");
		return;
	}
	...
	{
		draw_info(0, COLOR_WHITE, op, "Your marked item is not armour!\n");
		return;
	}

	draw_info(0, COLOR_WHITE, op, "Applying armour enchantment.");
...
static void improve_armour(object *op, object *improver, object *armour)
{
	...
	{
		draw_info(0, COLOR_WHITE, op, "You are not yet powerful enough to improve this armour.");
		return;
	}
	...
	{
		draw_info(0, COLOR_WHITE, op, "The armour value of this equipment cannot be further improved.");
	}
