...
void apply_armour_improver(object *op, object *tmp)
{
	...
	if (!armor)
	{
		new_draw_info(0, COLOR_WHITE, op, "You need to mark an armor object.");
		return;
	}
	...
	{
		new_draw_info(0, COLOR_WHITE, op, "Your marked item is not armour!\n");
		return;
	}

	new_draw_info(0, COLOR_WHITE, op, "Applying armour enchantment.");
...
static void improve_armour(object *op, object *improver, object *armour)
{
	...
	{
		new_draw_info(0, COLOR_WHITE, op, "You are not yet powerful enough to improve this armour.");
		return;
	}
	...
	{
		new_draw_info(0, COLOR_WHITE, op, "The armour value of this equipment cannot be further improved.");
	}
