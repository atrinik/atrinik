...
# Region maps are generated by a native Linux server because the MinGW binary
# cannot run in the cross-build container. Keep the generator's mutable data
# entirely in package staging; never use or modify server/data.
