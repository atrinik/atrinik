...
extern void widget_show_texture(widgetdata *widget);
...
extern void widget_inventory_render(widgetdata *widget);
extern void widget_inventory_event(widgetdata *widget, SDL_Event *event);
...
extern void menu_inventory_drop(widgetdata *widget, int x, int y);
extern void menu_inventory_dropall(widgetdata *widget, int x, int y);
...
extern void menu_inventory_drag(widgetdata *widget, int x, int y);
...
/* src/gui/settings_client.c */
extern void settings_client_open(void);
/* src/gui/settings_keybinding.c */
...
extern void textwin_tabs_allowed_remove(textwin_struct *textwin, const char *tab_name);
extern void textwin_tabs_allowed_add(textwin_struct *textwin, const char *tab_name);
...
extern void widget_textwin_deinit(widgetdata *widget);
extern void widget_textwin_init(widgetdata *widget);
extern void widget_textwin_load(widgetdata *widget, const char *keyword, const char *parameter);
extern void widget_textwin_save(widgetdata *widget, FILE *fp, const char *padding);
