...
extern void keybind_process(keybind_struct *keybind, SDL_EventType type);
...
extern int video_is_fullscreen(void);
extern int video_fullscreen_toggle(void);
...
/* src/events/keys.c */
extern key_struct keys[SDL_NUM_SCANCODES];
