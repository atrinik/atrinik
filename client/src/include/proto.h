...
extern object *object_find(int32_t tag);
extern void object_remove(object *op);
extern void object_remove_inventory(object *op);
extern object *object_create(object *env, int32_t tag, int bflag);
...
extern char *string_estrdup(const char *s, const char *file, uint32_t line);
extern char *string_estrndup(const char *s, size_t n, const char *file, uint32_t line);
