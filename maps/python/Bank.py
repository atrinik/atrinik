...
class Bank:
	...
	def handle_chat(self, msg):
		...
		# Make a deposit.
			...
			self._inf.add_msg("For example, type <green>1 gold, 99 silver, 20 copper</green>, <green>50 copper</green>, or <green>all</green>.")
		...
		# Make a withdrawal.
			...
			self._inf.add_msg("For example, type <green>1 mithril</green>, <green>2 gold, 50 silver</green>, <green>40 copper</green>, or <green>all</green>.")
