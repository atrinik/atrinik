...
def main():
	...
	if msg == "hi" or msg == "hey" or msg == "hello":
		...
		me.SayTo(activator, "\nTo use the construction skill, you need to buy a construction builder and a construction destroyer. With the destroyer, you can destroy previously built objects or walls. Use the builder to build walls, windows, fireplaces, and so on. To use either the destroyer or the builder, you must first apply it, and then type\n~/use_skill construction~ or find the construction skill in your skill list, press enter and use CTRL + direction.\n\n^Information about materials^")
