...
if msg == "hello" or msg == "hi" or msg == "hey":
	...
	if not qm.started():
		...
		me.SayTo(activator, "You still need to kill %d fire demon%s.\nMany of them can be found in the nearby volcano. Use the red portal to enter it." % (to_kill, to_kill > 1 and "s" or ""), 1)

# Accept the quest.
elif msg == "accept":
	if not qm.started():
		me.SayTo(activator, "\nKill at least %d fire demons in the nearby volcano and I will teach you the spell meteor. Use the red portal to enter the volcano." % quest["kills"])
		qm.start()
	elif qm.completed():
