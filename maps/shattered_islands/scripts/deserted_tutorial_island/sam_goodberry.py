...
def main():
    if not qm.started_part(1):
        if msg == "hello":
            ...
            inf.add_link("I don't remember much... what storm?", dest = "storm")
            ...
            inf.add_link("Deserted island?", dest = "deserted")
            ...
            inf.add_link("Should we take a look around?", dest = "takelook")
            ...
            inf.add_link("What if I get lost?", dest = "getlost")
        ...
        if msg == "hello":
            ...
            inf.add_link("Can't we gather some mushrooms?", dest = "mushrooms")
            ...
            inf.add_link("What about below the surface?", dest = "belowsurface")

        elif msg == "belowsurface":
            ...
            inf.add_link("I'll go have a look around.", dest = "havelook")
        ...
        if msg == "hello":
            ...
            inf.add_link("I saw some trees next to the lake.", dest = "sawtrees")
