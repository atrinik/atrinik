...
def main():
	if msg == "hello" or msg == "hi" or msg == "hey":
		...
		inf.add_link2("<a=:touhou>Ask about the Eastern Project.</a>")
		inf.add_link2("<a=:main_menu>Ask about something else.</a>")
	elif msg == "town":
		inf.add_msg("Try asking me some stuff about this town.  I might be able to help.")
		inf.add_link2("<a=:centennial>Ask why the town is called Centennial.</a>")		
		inf.add_link2("<a=:witch>Ask about the witches.</a>")
		inf.add_link2("<a=:main_menu>Ask about something else.</a>")
		...
		inf.add_link2("<a=:tomboyish fairy>Ask about the tomboyish fairy.</a>")
		inf.add_link2("<a=:main_menu>Ask about something else.</a>")
	elif msg == "touhou":
		...
		inf.add_link2("<a=:th_chars>Ask about the other characters.</a>")
		inf.add_link2("<a=:main_menu>Ask about something else.</a>")
	elif msg == "daiyousei":
		...
		inf.add_link2("<a=:nekokayou>Fan series.</a>")
		inf.add_link2("<a=:th_chars>Ask about the other characters.</a>")
		inf.add_link2("<a=:main_menu>Ask about something else.</a>")
	elif msg == "alice":
		...
		inf.add_link2("<a=:witch>Witch?  Isn't that what this school teaches?</a>")
		inf.add_link2("<a=:th_chars>Ask about the other characters.</a>")
		inf.add_link2("<a=:main_menu>Ask about something else.</a>")
	elif msg == "patchouli":
