...
def main():
	if msg == "hello" or msg == "hi" or msg == "hey":
		...
		# Not started?
		if not qm.started():
			me.SayTo(activator, "This is my <a>unique</a> shop, but I'm afraid I can't identify your items, since I was hurt in this <a>fight</a> a while ago...", 1)
		elif qm.completed():
			me.SayTo(activator, "Thank you for killing Torathog the stone giant. You are free to use this <a>unique</a> shop.", 1)
		elif qm.finished():
			...
			me.SayTo(activator, "Have you had any luck killing Torathog the stone giant from the Old Outpost? Or are you here to use my <a>unique</a> shop?", 1)
		...
		if msg == "fight":
			me.SayTo(activator, "\nA while ago I was hurt badly in a fight with one of the <a>stone giants</a> from Old Outpost. I can no longer do the job of a smith. If you need a smith, there is one near the Brynknot docks. Failing that, there's superb smiths in Greyton and Asteria.")
		elif msg == "stone giants":
			me.SayTo(activator, "\nWell, I think it was a stone giant from Old Outpost at any rate. I was near the entrance to Old Outpost - north of Aris in the Giant Mountains - taking a walk, when one of them saw me, and hurt me badly in the fight that followed.\nHis name was <a>Torathog</a>, since he kept yelling at me, saying things like 'Torathog will eat ya!'.")
		elif msg == "torathog":
