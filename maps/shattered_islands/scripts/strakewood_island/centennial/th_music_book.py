...
def main():
	...
	if GetEventNumber() == EVENT_SAY:
		...
		inf.add_link("Scarlet Beyond a Crimson Dream (book 6)", dest = "/sys_tell th_31.mid")
		...
		inf.add_link("Shanghai Teahouse ~ Chinese Tea (book 6 stg 3)", dest = "/sys_tell th_28.mid")
		...
		inf.add_link("Broken Moon (Suika, book 7.5 stg ENDS)", dest = "/sys_tell th_11.mid")
		...
		inf.add_link("Native Faith (Suwako, book 10 stg EX)", dest = "/sys_tell th_33.mid")
		...
		inf.add_link("At the End of Spring (book 12 stg 1)", dest = "/sys_tell th_34.mid")
