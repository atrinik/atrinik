...
def main():
	...
	if GetEventNumber() == EVENT_SAY:
		...
		inf.add_link("Scarlet Beyond a Crimson Dream (book 7)", dest = "/sys_tell th_31.mid")
		...
		inf.add_link("Phantom Ensemble (Prismriver Sisters, book 7)", dest = "/sys_tell th_29.mid")
		...
		inf.add_link("Native Faith (Suwako, book 10 stg 5)", dest = "/sys_tell th_33.mid")
