...
def main():
	if msg == "hello":
		...
		inf.add_link("<a=:the strongest>You're the strongest?</a>")
		inf.add_link("<a=:not the strongest>No way, that's impossible!</a>")
		inf.add_link("<a=:strongest fairy>You're the strongest fairy... maybe.</a>")
		inf.add_link("<a=:idiot>What?  Are you dumb or something?</a>")
		...
		inf.add_link("<a=:hello>OK.</a>")
		inf.add_link("<a=:idiot>That was childish.</a>")
		inf.add_link("<a=close:>Goodbye.</a>")
	elif msg == "not the strongest" or msg == "weak" or msg == "strongest fairy":
		inf.add_msg(random.choice(_angry_cirnoisms))
		inf.add_link("<a=:hello>Whatever.</a>")
		inf.add_link("<a=:idiot>You must be stupid or something.</a>")
		inf.add_link("<a=:cirno>Oh, you must think you're Cirno.</a>")
		inf.add_link("<a=close:>Goodbye.</a>")
	elif msg == "the strongest" or msg == "strong" or msg == "cirno":
		inf.add_msg(random.choice(_happy_cirnoisms))
		inf.add_link("<a=:hello>OK.</a>")
		inf.add_link("<a=:idiot>Well, that was stupid.</a>")
		inf.add_link("<a=close:>Goodbye.</a>")
