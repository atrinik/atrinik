...
def main():
	...
	if not "incuna" in pl.region_maps:
		if msg == "hi" or msg == "hey" or msg == "hello":
			...
			inf.add_link("Er... Yes...")
			inf.add_link("<a=:nocomment>&lt;no comment&gt;</a>")

		elif msg == "er... yes...":
			inf.add_msg("Must have been painful, that! How's your memory doing?")
			inf.add_link("<a=:nocomment>Not so good...</a>")
			inf.add_link("<a=:nocomment>&lt;no comment&gt;</a>")

		elif msg == "nocomment":
			inf.add_msg("Hmm... well... at any rate, what is the reason behind your visit?")
			inf.add_link("Sam mentioned you might have a spare map of Incuna?")
			inf.add_link("Just looking around...")

		elif msg == "just looking around...":
			inf.add_msg("I see...")
			inf.add_link("Sam mentioned you might have a spare map of Incuna?")

		elif msg == "sam mentioned you might have a spare map of incuna?":
