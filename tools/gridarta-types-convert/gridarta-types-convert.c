 ...
 *
 * To build: <pre>gcc -g -O3 -Wall -pedantic gridarta-types-convert.c -I../../server/src/include -o gridarta-types-convert</pre>
 * To run: <pre>./gridarta-types-convert ../../arch/dev/conf/types.xml</pre>
...
const char *destination_dir = "../../server/doc"; /**< Root destination dir. */
...
static const flag_definition flags[] = {
	...
	{"can_reflect_missile", "FLAG_CAN_REFL_MISSILE"},
	{"reflect_spell", "FLAG_REFL_SPELL"},
	{"can_reflect_spell", "FLAG_CAN_REFL_SPELL"},
	...
	{"is_vul_elemental", "FLAG_VUL_ELEMENTAL"},
	{"is_proof_elemental", "FLAG_PROOF_ELEMENTAL"},
	{"is_vul_magic", "FLAG_VUL_MAGIC"},
	{"is_proof_magic", "FLAG_PROOF_MAGIC"},
	{"is_vul_physical", "FLAG_VUL_PHYSICAL"},
	{"is_proof_physical", "FLAG_PROOF_PHYSICAL"},
